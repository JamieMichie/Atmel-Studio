...
#define LCD_DELAY_ENABLE_PULSE 10      /**< enable signal pulse width in micro seconds */
#endif
...
void int2string(int16_t integer);
void float2string(float floatingpoint);
void signedint2string(int16_t integer);
#endif //LCD_H
